...
%prep
%setup -q -n PPI-1.278
cd %{_builddir}/PPI-1.278
pushd ..
cp -a PPI-1.278 buildavx2
popd
...
cp %{_builddir}/PPI-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-PPI/9ef6c5018719047ada4959c81335f46ab8bde0e3 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-PPI/9ef6c5018719047ada4959c81335f46ab8bde0e3
